...
#include "kengine/systems.hpp"
//#include "kengine/graphics/sprite_renderer.hpp"
...
namespace core
{
  ...
  {
    m_registry.emplace<kengine::component::Camera> (m_camera);
    m_registry.emplace<kengine::component::Position> (m_camera, x, y, z);
    m_registry.emplace<kengine::component::Dimension> (m_camera, m_initial_width + x, m_initial_height + y);
  }

  void Game::update_camera (const double x, const double y, const double z)
  {
    auto& pos = m_registry.get<kengine::component::Position> (m_camera);
    pos.x     = x;
    pos.y     = y;
    pos.z     = z;
  }
