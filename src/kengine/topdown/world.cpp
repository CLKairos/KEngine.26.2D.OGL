...
#include <cmath>
#include <bitset>
#include "kengine/core/map_grid.hpp"
#include "kengine/core/tile.hpp"
...
namespace topdown
{
  ...
  void World::AddBody (std::shared_ptr<kengine::topdown::Body> body) { this->Bodies.emplace_back (body); }

  void World::RemoveBody (std::shared_ptr<kengine::topdown::Body> body)
  {
