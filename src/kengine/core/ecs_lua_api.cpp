...
namespace script
{
  ...
  {
    if (m_registry.has<kengine::component::Position> (entity))
    {
      const auto& position = m_registry.get<kengine::component::Position> (entity);
  ...
  void ECSLuaApi::create_layer (const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::LayerT> (
  ...
  void ECSLuaApi::add_sprite_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    auto& sprite = m_registry.emplace<kengine::component::SpriteT> (id, texture_name);
    sprite.frame = frame;
  ...
  void ECSLuaApi::add_position_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Position> (id, x, y, z);
  }
  ...
  void ECSLuaApi::add_dimension_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Dimension> (id, w, h);
  }

  void ECSLuaApi::add_animation_component (entt::registry::entity_type id, const sol::table& obj)
  {
    auto& anim_player = m_registry.emplace<kengine::component::AnimationPlayer> (id);
  ...
  {
    m_registry.emplace<kengine::component::Tileview> (id);
  }
  ...
  void ECSLuaApi::add_movement_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Movement> (id, speed, gravity, constant_velocity);
  }

  void ECSLuaApi::add_player_component (entt::registry::entity_type id, const sol::table& obj)
  {
    m_registry.emplace<kengine::component::Player> (id);
  }
  ...
  void ECSLuaApi::add_transform_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Transform> (id, rotation, scale);
  }
  ...
  void ECSLuaApi::add_body_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Body2D> (id, bb, bbpos, movement_speed);
  }
  ...
  void ECSLuaApi::add_text_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Text> (id, text, font_name, color, is_static);
  }
  ...
  //   kengine::component::ParticleEmitter::Type emitter_type = kengine::component::ParticleEmitter::FIRE_EMITTER;
  //   if (type == "fire")
  //   {
  //     emitter_type = kengine::component::ParticleEmitter::Type::FIRE_EMITTER;
  //   }
  //   else if (type == "snow")
  //   {
  //     emitter_type = kengine::component::ParticleEmitter::Type::SNOW_EMITTER;
  //   }
  //   m_registry.emplace<kengine::component::ParticleEmitter> (id, emitter_type, quantity);
  // }

  void ECSLuaApi::add_tile_component (entt::registry::entity_type id, const sol::table& obj)
  {
    m_registry.emplace<kengine::component::Tile> (id, 0, false);
  }
  ...
  void ECSLuaApi::add_scroll_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Scroll> (id, speed);
  }
  ...
  void ECSLuaApi::add_name_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Name> (id, name);
  }
  ...
  void ECSLuaApi::add_npc_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::NPC> (id, path);
  }

  void ECSLuaApi::add_character_animation_component (entt::registry::entity_type id)
  {
    m_registry.emplace<kengine::component::CharacterAnimation> (id);
  }
  ...
  void ECSLuaApi::add_shape_component (entt::registry::entity_type id, const sol::table& obj)
  {
    ...
    m_registry.emplace<kengine::component::Shape> (id, vertices, layer_id);
  }
  ...
  void ECSLuaApi::add_color_component (entt::registry::entity_type id, const sol::table& obj)
  {
    if (obj["rgba"] != sol::lua_nil)
    {
      ...
      m_registry.emplace<kengine::component::Color> (id, color[1], color[2], color[3], color[4]);
    }
    else if (obj["rgb"] != sol::lua_nil)
    {
      const sol::table& color = obj["rgb"];
      m_registry.emplace<kengine::component::Color> (id, color[1], color[2], color[3]);
    }
    else if (obj["hex"] != sol::lua_nil)
    {
      const std::string& hex_str = obj["hex"];
      m_registry.emplace<kengine::component::Color> (id, hex_str);
    }
  }

  void ECSLuaApi::add_vertical_component (entt::registry::entity_type id)
  {
    m_registry.emplace<kengine::component::Vertical> (id);
  }
