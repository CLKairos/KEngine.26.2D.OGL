#include "kengine/audio/sound.hpp"
#include "kengine/audio/vorbisogg.hpp"
...
namespace audio
{
  ...
  void Sound::Update() { alGetSourcei (this->Source, AL_SOURCE_STATE, &this->State); }
  ...
  void Sound::init (const char* filepath)
  {
    ...
    alBufferData (
        this->Buffer, this->Format, &this->BufferData[0], static_cast<ALsizei> (this->BufferData.size()), this->Freq);
