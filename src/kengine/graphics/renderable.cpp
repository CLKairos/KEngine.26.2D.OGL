...
namespace graphics
{
  Renderable::Renderable (glm::vec3 position, glm::vec2 dimensions, GLboolean visible)
    : Pos (position), Dimensions (dimensions), RealDimensions (dimensions), Visible (visible)
  {
  }
  Renderable::Renderable (GLint x, GLint y, GLint w, GLint h, GLboolean visible)
    : Renderable (glm::vec3 (x, y, 0.f), glm::vec2 (w, h), visible)
  {
  }
