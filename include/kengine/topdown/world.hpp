...
namespace topdown
{
  ...
  {
  private:
    std::vector<std::shared_ptr<kengine::topdown::Body>> Bodies;
  ...
  public:
    ...
    ~World();
    void AddBody (std::shared_ptr<kengine::topdown::Body> body);
    void RemoveBody (std::shared_ptr<kengine::topdown::Body> body);
