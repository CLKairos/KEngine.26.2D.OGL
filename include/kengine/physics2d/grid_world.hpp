...
namespace physics2d
{
  ...
  private:
    ...
    std::vector<std::shared_ptr<kengine::physics2d::Body>> Bodies;
    glm::vec2 CameraOffset         = glm::vec2 (0.f, 0.f);
    const unsigned TILE_DIMENSIONS = 32;
    const core::TileMap& m_tile_map;
    std::vector<std::shared_ptr<kengine::physics2d::WaterSurface>> m_water_surfaces;
  ...
  public:
    ...
    ~GridWorld();
    void AddBody (std::shared_ptr<kengine::physics2d::Body> body);
    void RemoveBody (std::shared_ptr<kengine::physics2d::Body> body);
    ...
    void add_water_surface (const std::shared_ptr<kengine::physics2d::WaterSurface>& water_surface);
    void remove_water_surface (const std::shared_ptr<kengine::physics2d::WaterSurface>& water_surface);
